...
let color = "orange"; //default value for a question
...
<main class="autoWidth">
  ...
  <div id="part1">
    <h2>The story</h2>
    <p>
      Hjalmar's fascination with the stars began in his childhood, when his grandfather would tell him stories
      about
      constellations and distant galaxies. He would spend hours with his grandfather, gazing at the night sky, and
      dreaming of exploring the universe. As he grew older, his passion for astronomy only deepened, and he
      decided to
      pursue it as a career.
      <br><br>
      One crisp autumn evening, as Hjalmar was peering through his telescope, he spotted something extraordinary—a
      streak of light cutting across the sky. It was a shooting star, and in that moment, he made a wish. "I wish
      for a
      chance to unravel the mysteries of the universe," he whispered to himself.
      <br><br>
      Little did Hjalmar know, his wish could come true in the most unexpected way. <br> <br>

      The following morning, a important-looking, ${color} letter arrived in Hjalmar's letterbox. It was an invitation
      from
      the renowned Lund Observatory in Stockholm, offering him a position as a junior astronomer. It was an
      opportunity
      he knew he shouldn't pass up, but it would mean leaving behind the quiet comforts of Solberg. <br>
      <br>
    </p>

    <h3>Accept the offer?</h3>
    <button id="wayBtn" disabled>Accept the offer and leave Solberg behind</button>
    <button id="wayBtn2" disabled>Decline and stay in Solberg</button>
  ...
  <div id="part2">
    <p>
      Hjalmar bid farewell to his family and his beloved town, embarking on a new adventure to the bustling
      capital
      city. The observatory was a hub of activity, filled with brilliant minds and cutting-edge equipment. Hjalmar
      was
      in awe of the state-of-the-art telescopes and the vast array of resources at his disposal. <br>
      <br>
      As the months passed, Hjalmar's dedication and enthusiasm caught the attention of his colleagues and
      mentors. He
      spent countless nights observing celestial phenomena, making groundbreaking discoveries, and publishing his
      research in prestigious scientific journals. Hjalmar's reputation as an exceptional astronomer grew, and he
      became
      known not just in Sweden but across the international scientific community. <br>
      <br>
      But Hjalmar's heart was still in Solberg, and he longed for the quiet serenity of his hometown. One day, as
      he was
      studying a particularly enigmatic cluster of stars, he remembered his grandfather's tales of the wonders of
      the
  ...
  <ul id="#card">
    <li>
      <h1>Test</h1>
      <p>${story[0].text}</p>
      <button>${story[0].options[0].msg}</button>
      <button>${story[0].options[1].msg}</button>
    </li>
  </ul>
...
const wayButton1 = document.querySelector('#wayBtn')
const wayButton2 = document.querySelector('#wayBtn2')
